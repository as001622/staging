...
public class NavigationViewHolder extends RecyclerView.ViewHolder{
    ...
    public NavigationViewHolder(View itemView,NavRecyclerViewListener listener,final String mAdapterToUseTag) {
        super(itemView);
        mListener=listener;
        ...
        mDeleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mAdapterToUseTag==SearchPresenterImpl.MAIN_RECYCLERVIEW_TAG) {
